...
Join the ZisK community and contribute to the future of scalable, quantum-resistant computation:

<div style="display: flex; gap: 20px; align-items: center; margin-top: 2rem;">

<a href="https://github.com/0xPolygonHermez/zisk" target="_blank" style="display: flex; align-items: center; gap: 8px; text-decoration: none; color: white; border: 1px solid #ddd; padding: 12px 16px; border-radius: 8px; transition: all 0.2s ease;">
  ...
  <span style="font-weight: 500; color: white;">GitHub</span>
</a>

<a href="https://discord.gg/bh2b7JurXH" target="_blank" style="display: flex; align-items: center; gap: 8px; text-decoration: none; color: white; border: 1px solid #ddd; padding: 12px 16px; border-radius: 8px; transition: all 0.2s ease;">
  <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
  ...
  <span style="font-weight: 500; color: white;">Discord</span>
</a>
