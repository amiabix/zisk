...
ZisK is a high-performance zkVM (Zero-Knowledge Virtual Machine) for generating zero-knowledge proofs of arbitrary program execution. It enables developers to prove computational correctness without revealing internal state.
...
Ready to start building with ZisK? Join our community and explore the codebase:

<div style="display: flex; gap: 1.5rem; margin-top: 2rem; justify-content: center; align-items: center;">

<a href="https://discord.gg/bh2b7JurXH" target="_blank" style="text-decoration: none; display: flex; align-items: center; gap: 0.5rem;">
  ...
  <span style="color: #5865F2; font-weight: 500;">Discord</span>
</a>

<a href="https://github.com/0xPolygonHermez/zisk" target="_blank" style="text-decoration: none; display: flex; align-items: center; gap: 0.5rem;">
...
> **Next Steps:** Check out our [Installation Guide](./getting_started/installation.md) to get ZisK up and running on your system.